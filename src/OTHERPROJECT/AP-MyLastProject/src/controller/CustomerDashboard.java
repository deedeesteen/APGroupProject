...
public class CustomerDashboard extends JFrame {
    ...
    public void dashGUI() {
        ...
        transac.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Customer sampleCustomer = new Customer(2100463, "Leigh-Ann", "Female", "Customer", 2100463);
                Transactions transaction = new Transactions(sampleCustomer);
        ...
        custinfo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Customer sampleCustomer = new Customer(2100463, "Leigh-Ann", "Female", "Customer", 2100463);
                CustomerInfoGUI custinfo = new CustomerInfoGUI(sampleCustomer);
                desktop.add(custinfo);

                try {
                    custinfo.setSelected(true);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
