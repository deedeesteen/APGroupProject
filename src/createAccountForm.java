 ...
 * // Customer newCustomer = new Customer(new User(userId, userpassword,
 * userrole,
 * // userName), userId);
 * //Customer newCustomer = new Customer(userId, userpassword, userrole,
 * userName, userId);
 * Customer newCustomer = new Customer(userId, userpassword, userName,
 * usergender, userRole, userId);
 ...
 * Employee newEmployee = new Employee(userId, userpassword, userrole, userName,
 * userId);
 ...
 * // Customer newCustomer = new Customer(custId, custpassword, empName,
 * emprole);
